...
public class YandexTranslator implements Runnable {
		...
		for (String word : newWords) {
			...
			if (mean != null) {
				if (!mean.equals(word) && !word.contains(" ")) {
					...
					System.out.println( i + "/"+newWords.size()+":" + word + "->" + mean);
					i++;
				}
			}
	...
	private String search(String where, String word) {
		...
		if (where.equals("dict")) {
			URL = "https://dictionary.yandex.net/api/v1/dicservice.json/lookup?key=dict.1.1.20140823T062641Z.70f794a8aa21f919.7f2ec2ba886dcc8a15679e1f1eb44209640da996&lang=en-tr&text="
					+ word;
		} else if (where.equals("translate")) {
			URL = "https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20140823T085734Z.0c87d73c24509f03.c4ac0c01312f7fa91fed68943068b0d08a6e6df3&lang=en-tr&text="
					+ word;
		}
		...
		try {
			...
			if (ok == false) {
				JOptionPane.showMessageDialog(null,
						"Sözlük güncellenemedi lütfen internet bağlantınızı kontrol edin !");
			} else {
